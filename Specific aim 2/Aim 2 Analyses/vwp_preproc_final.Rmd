...
****SKIP THIS STEP IF YOU DO NOT HAVE THE INDIVIDUAL LEVEL SUBJECT DATA IN YOUR DIRECTORY***
...
```{r}
df = read.csv('vwp_raw_data_concatenated.csv')
df = df %>%
...
df3 = df2 %>%
  ...
  mutate(fixation_type = factor(fixation_type),
